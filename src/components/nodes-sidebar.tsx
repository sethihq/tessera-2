...
const workflows = [
    {
        ...
        payload: {
            nodes: [
                { id: 'char', type: 'input', position: { x: 0, y: 0 }, data: { label: 'Character', nodeType: 'character', fields: [{ id: 'identity', label: 'Identity', type: 'textarea', value: 'Goku, 8-bit, orange gi, spiky black hair' }, { id: 'base_pose', label: 'Base Pose', type: 'text', value: 'standing, facing right' }] } },
                { id: 'anim', type: 'input', position: { x: 0, y: 250 }, data: { label: 'Animation', nodeType: 'animation', fields: [{ id: 'title', label: 'Title', type: 'text', value: 'Kamehameha fireball attack' }] } },
                { id: 'keyframe1', type: 'input', position: { x: 0, y: 460 }, data: { label: 'Keyframe 1', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'Goku stands in a ready stance, gathering energy.' }] } },
                { id: 'keyframe2', type: 'input', position: { x: 0, y: 670 }, data: { label: 'Keyframe 2', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'Hands cupped at his side, a small ball of blue energy appears.' }] } },
                { id: 'keyframe3', type: 'input', position: { x: 0, y: 880 }, data: { label: 'Keyframe 3', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'The energy ball grows slightly larger and brighter.' }] } },
                { id: 'keyframe4', type: 'input', position: { x: 0, y: 1090 }, data: { label: 'Keyframe 4', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'Goku thrusts his hands forward, beginning to unleash the blast.' }] } },
                { id: 'keyframe5', type: 'input', position: { x: 0, y: 1300 }, data: { label: 'Keyframe 5', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'A beam of energy erupts from his hands, extending halfway across the frame.' }] } },
                { id: 'keyframe6', type: 'input', position: { x: 0, y: 1510 }, data: { label: 'Keyframe 6', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'The beam is at full extension, powerful and wide, then dissipates.' }] } },
