...
const workflows = [
    {
        ...
        payload: {
            nodes: [
                ...
                { id: 'anim', type: 'input', position: { x: 0, y: 250 }, data: { label: 'Animation', nodeType: 'animation', fields: [{ id: 'title', label: 'Title', type: 'text', value: 'Dragon Fist Attack' }] } },
                { id: 'keyframe1', type: 'input', position: { x: 0, y: 460 }, data: { label: 'Keyframe 1', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'Goku crouches, charging energy. His fists are clenched, and a faint yellow aura flares around him.' }] } },
                { id: 'keyframe2', type: 'input', position: { x: 0, y: 670 }, data: { label: 'Keyframe 2', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'He lunges forward, right arm pulled back, preparing a powerful punch. A motion blur indicates speed.' }] } },
                { id: 'keyframe3', type: 'input', position: { x: 0, y: 880 }, data: { label: 'Keyframe 3', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'The punch is thrown straight forward. Concentrated golden energy gathers at the tip of his fist.' }] } },
                { id: 'keyframe4', type: 'input', position: { x: 0, y: 1090 }, data: { label: 'Keyframe 4', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'The head of a golden, roaring energy dragon begins to emerge from his fist, flying forward.' }] } },
                { id: 'keyframe5', type: 'input', position: { x: 0, y: 1300 }, data: { label: 'Keyframe 5', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'The dragon is now larger, its serpentine body coiling as it lunges further out from the point of impact.' }] } },
                { id: 'keyframe6', type: 'input', position: { x: 0, y: 1510 }, data: { label: 'Keyframe 6', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'The golden dragon is fully manifested, flying forward and away from Goku, who holds his follow-through punch pose.' }] } },
