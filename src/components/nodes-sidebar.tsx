...
const workflows = [
    {
        ...
        payload: {
            nodes: [
                { id: 'char', type: 'input', position: { x: 0, y: 0 }, data: { label: 'Character', nodeType: 'character', fields: [{ id: 'identity', label: 'Identity', type: 'textarea', value: 'A majestic pixel art dragon, side profile, with large wings and a long tail.' }, { id: 'base_pose', label: 'Base Pose', type: 'text', value: 'Mid-flight, wings fully extended.' }] } },
                { id: 'anim', type: 'input', position: { x: 0, y: 250 }, data: { label: 'Animation', nodeType: 'animation', fields: [{ id: 'title', label: 'Title', type: 'text', value: 'Soaring Dragon Flight' }] } },
                { id: 'keyframe1', type: 'input', position: { x: 0, y: 460 }, data: { label: 'Keyframe 1', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'The dragon is at the peak of its flight, wings fully extended upwards, tail slightly raised.' }] } },
                { id: 'keyframe2', type: 'input', position: { x: 0, y: 670 }, data: { label: 'Keyframe 2', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'Wings begin the powerful downstroke, now level with the body. The head dips slightly.' }] } },
                { id: 'keyframe3', type: 'input', position: { x: 0, y: 880 }, data: { label: 'Keyframe 3', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'The wings are at the bottom of their stroke, fully extended downwards, propelling the dragon forward.' }] } },
                { id: 'keyframe4', type: 'input', position: { x: 0, y: 1090 }, data: { label: 'Keyframe 4', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'Wings start their upstroke, partially folded and moving towards the body. The tail lowers.' }] } },
                { id: 'keyframe5', type: 'input', position: { x: 0, y: 1300 }, data: { label: 'Keyframe 5', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'The wings are now pulled in close to the body, moving upwards to prepare for the next beat.' }] } },
                { id: 'keyframe6', type: 'input', position: { x: 0, y: 1510 }, data: { label: 'Keyframe 6', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'Wings are reaching their highest point again, almost fully extended, ready to loop back to frame 1.' }] } },
