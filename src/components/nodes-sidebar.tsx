...
const workflows = [
    {
        ...
        payload: {
            nodes: [
                ...
                { id: 'keyframe1', type: 'input', position: { x: 0, y: 460 }, data: { label: 'Keyframe 1', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'knight raises sword' }] } },
                { id: 'keyframe2', type: 'input', position: { x: 0, y: 670 }, data: { label: 'Keyframe 2', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'sword is at the peak of its backswing' }] } },
                { id: 'keyframe3', type: 'input', position: { x: 0, y: 880 }, data: { label: 'Keyframe 3', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'sword swings down' }] } },
                { id: 'keyframe4', type: 'input', position: { x: 0, y: 1090 }, data: { label: 'Keyframe 4', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'sword at the end of its arc' }] } },
                { id: 'keyframe5', type: 'input', position: { x: 0, y: 1300 }, data: { label: 'Keyframe 5', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'knight recovering from swing' }] } },
                { id: 'keyframe6', type: 'input', position: { x: 0, y: 1510 }, data: { label: 'Keyframe 6', nodeType: 'keyframe', fields: [{ id: 'description', label: 'Description', type: 'textarea', value: 'knight back to ready stance' }] } },
